...
from nicegui import Client, events, ui, app
...
class local_file_picker(ui.dialog):
    def __init__(self, directory: "", *,
        ...
        with self, ui.card():
            ...
            }, html_columns=[0]).classes('w-96 h-96').style('width: 55vh; height: 70vh; font-size: 15px;').on('cellDoubleClicked', self.handle_double_click)
